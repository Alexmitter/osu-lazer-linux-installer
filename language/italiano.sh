...
APPIMG_CHROOT_1="La AppImage di osu!lazer deve essere impostata come eseguibile"
APPIMG_CHROOT_2="Eseguiremo sudo chmod +x $path2, se non ti fidi di questo script puoi farlo tu stesso"
APPIMG_CHROOT_3="Premi invio quando sei pronto"
APPIMG_CHROOT_ERROR="Errore: AppImage non è un eseguibile"
