...
APPIMG_CHMOD_1="osu!lazer AppImage has to be set executable"
APPIMG_CHMOD_2="We will execute sudo chmod +x $path2 here, if you do not trust this script, do it yourself"
APPIMG_CHMOD_3="Press enter if ready"
APPIMG_CHMOD_ERROR="Error: AppImage not executable"
APPIMG_STARTING="Executing osu!lazer AppImage..."
